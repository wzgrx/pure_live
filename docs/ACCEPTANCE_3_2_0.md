...
| 新平台 | 参考 biliup / bililive-go 做能力合同、适配、测试、入口与说明 | AcFun 协议、目录/分类/作者搜索、分享与录制解析入口已接入，在线人数开关和能力说明已补齐；真实官网稀疏分页通过。远端弹幕尚未接入，完整录制输出和实际观看仍待验收，见 `ACFUN_NAVIGATION_AUDIT_2026_09_05.md` |
