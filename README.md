...
- **Android 小窗弹幕设置补证**：当前候选已在 K90 完成固定预览开/关、控制组收起/展开和两次进程重启持久化；测试器改用双语语义路由与目标页断言，结束后规范 Hive 逐字节恢复、应用停止。A2-04 进入 RUN，Windows 双栏、逐项样式、默认/模板、真实小窗与长测继续；详见[原生审计](docs/ANDROID_PIP_DANMAKU_SETTINGS_NATIVE_AUDIT_2026_09_12.md)。
