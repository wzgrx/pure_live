...
- **新增CPU对照诊断**：[窗口可见性与观察条件](WINDOWS_CPU_CONTEXT_AUDIT_2026_09_07.md)。同候选空关注页可见约0.958%、最小化约0.045%、恢复约0.924%；重启和同字节exe改名均未消除高值，因此未确认“观察工具造成”的初始假设。未取得Dart热栈，下一步做固定SDK最小Windows runner对照；根因/Release性能仍未闭合，没有凭猜测加延时或修改业务代码。
