// Opt-in real HTTP requests using the production Twitcasting adapter and Dio
...
void main() {
  test(
    'Twitcasting production directory, playback, recorder and fresh recovery contracts',
    () async {
      await io.HttpOverrides.runWithHttpOverrides(() async {
        ...
        try {
          ...
          final categoryRooms = await site.getCategoryRooms(categories.single.children.first, pageSize: 60);
          ...
          final result = {
            ...
            'probe': 'twitcasting-production-contract',
            'directoryCount': rooms.length,
            'categoryCount': categories.single.children.length,
            'categoryRoomCount': categoryRooms.length,
          ...
          final output = io.Platform.environment['PURELIVE_TWITCASTING_PROBE_OUTPUT'];
    ...
    skip: io.Platform.environment['PURELIVE_TWITCASTING_LIVE_PROBE'] != '1',
