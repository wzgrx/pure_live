...
| ID | 状态 | 验收内容 |
|---|---|---|
| A2-01 | RUN | 设置顶/中/底三级页面全部可达，长页滚动到边界，开关与数值无重叠 | 设置首页在 320×480 / 2.0 倍英文下曾溢出 119 像素且标题宽度为 0；现按窗口/文字缩放切换配置预览图标或文字动作，窄屏可从首项滚动到“备份与恢复”。页面尺寸编辑框另修订 164 像素标题行溢出。通用设置刷新率弹窗在 320×480 / 3.0 倍英文下曾右溢出 174/274/207 像素并向底部溢出 248 像素；现三档、耗电徽标和最高档选择均可滚动到达，五个相邻文件 17/17、全库 analyze 无问题。全部其余二、三级页与双端候选操作继续，详见 `docs/SETTINGS_APP_BAR_LAYOUT_AUDIT_2026_09_11.md`、`docs/PAGE_SETTINGS_DIALOG_LAYOUT_AUDIT_2026_09_11.md`、`docs/GENERAL_SETTINGS_REFRESH_RATE_DIALOG_LAYOUT_AUDIT_2026_09_11.md` |
