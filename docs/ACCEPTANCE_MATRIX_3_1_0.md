...
| ID | 状态 | 验收内容 |
|---|---|---|
| A2-01 | RUN | 设置顶/中/底三级页面全部可达，长页滚动到边界，开关与数值无重叠 | 设置首页在 320×480 / 2.0 倍英文下曾溢出 119 像素且标题宽度为 0；现按窗口/文字缩放切换配置预览图标或文字动作，窄屏可从首项滚动到“备份与恢复”。修改前 1 PASS / 1 FAIL，六个相邻设置测试文件最终 51/51、全库 analyze 无问题；全部二、三级页与双端候选操作继续，详见 `docs/SETTINGS_APP_BAR_LAYOUT_AUDIT_2026_09_11.md` |
