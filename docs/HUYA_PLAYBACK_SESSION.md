...
> 续签选线最新补充：[线路身份审计](HUYA_LINE_IDENTITY_AUDIT_2026_09_05.md)。新线路列表会重排或过滤失败项，
> 应按活动 CDN/协议/凭据家族匹配，旧序号不作为“同一线路”的身份。

> 2026-09-05 更新：下文第 1–3 节的网页模板优先、签名身份规则仅保留为网页后备契约和历史证据。当前 FLV 首选独立原生 WUP 契约；凭据到期仅预取备用地址，不替换健康连接。以 [最新修复与受控对照](HUYA_NATIVE_LEASE_FIX_2026_09_05.md) 为当前策略，勿把两种身份/令牌混用。
